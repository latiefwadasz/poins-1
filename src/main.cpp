...
uint256 hashGenesisBlock("0x66f1375be7b60592e036a57173d6b89153f1a4e6e45f1e48232cb98284fbf7b9"); //12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 300000); // Poins: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 60; // Poins: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa34a1e1303236243ffe95cc8ba7cda497b8d204b63cf521d1632fefa5bf36f21");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "POINS COIN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("042c640344d845e8b38f49505ea0d56a194607f76671f3ecf55b6ba21475f9d0420f45e61ec23568b17b4f269fcaeb79aaedc62919566b1082c6e5fdbd3f5ed5c3") << OP_CHECKSIG;
//==>040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9
        ...
        block.nVersion = 1;
        block.nTime    = 1521646127;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085422371;

        if (fTestNet)
        {
            block.nTime    = 1521646032;
            block.nNonce   = 386836309;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x0104b30761852d48ac31567d02e0fba795412e726bc7510f31a7bc454ba16f95"));
        block.print();
